...
echo "  pnpm exec context-sidecar context summary    # Inspect workspace summary"
echo "  pnpm exec context-sidecar context bootstrap repo"
echo "  pnpm serve:mcp                               # Start MCP server"
echo "  pnpm serve:api                               # Start HTTP API"
echo "  pnpm demo                                    # Run isolated demo workspace"
echo ""
